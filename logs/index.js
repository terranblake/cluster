...
if (EXCLUSIVE_FILTERS && EXCLUSIVE_FILTERS[0] === '')
    EXCLUSIVE_FILTERS = []

const INCLUSIVE_FILTERS = EXCLUSIVE_FILTERS.length > 0
    && []
    || EXCLUSIONS
    && EXCLUSIONS.split(' ')
    || [];
...
function trackFile(logFilePath) {
    ...
    console.log(`[logs]/[info]/[${namespace}] : tracking new log file for container ${containerName} at path ${logFilePath}`);
